...
/**
 * This class defines a quad object and is responsible for drawing a 4 sided
 * quad. A quad object constructor is created that accepts an array of 4 Points.
 * Multiple 4 sided objects are created that illustrate various sizes, location
 * and colors.
 */
...
public class Quad extends Shape {
	...
	public Quad() {
		...
		float dx[] = { 0.4f, 0.5f, 0.7f, 0.6f };
		float dy[] = { 0.3f, 0.3f, 0.5f, 0.8f };
