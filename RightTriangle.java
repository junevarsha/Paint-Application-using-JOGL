...
public class RightTriangle extends Shape {
	...
	public RightTriangle() {
		// Right triangle with center at origin
		// and base and height of size 1.
		float dxDefault[] = { 0.5f, 0.5f, 1.5f };
		float dyDefault[] = { 1.0f, 2.0f, 1.0f };

		initialize(dxDefault, dyDefault);
	}

	public RightTriangle(float[] x, float[] y) {
		initialize(x, y);
	}
	...
	public void redraw() {
		...
		// The right triangle is defined by positions relative to its location
		// stored
